...
public class ViewModel {
    ...
    public boolean validateArabicNumber(String arabicNumber) {
        Integer aramicNum = 0;
        try {
        ...
        if ((aramicNum < 0) || (aramicNum > MAX_NUMBER))
            return false;
        return true;
    }
    ...
    private final Status getInputStatus() {
    ...
    public void convertNumber() {
        ...
        if (rbArabToRomChooseValue.get()) {
            ArabicToRomanNumberConverter arabRomConverter = new ArabicToRomanNumberConverter();
            romanNumberValue.set(arabRomConverter.convert(Integer.parseInt(arabicNumberValue.get())));
        } else {
            RomanToArabicNumberConverter romArabConverter = new RomanToArabicNumberConverter();
            arabicNumberValue.set(String.valueOf(romArabConverter.convert(romanNumberValue.get())));
        }
