...
public class ViewModelTests {
    ...
    public void whenRomanNumberIsQWERTY() {
        ...
        assertEquals(false, viewModel.validateRomanNumber(viewModel.getRomanNumberProperty().get()));
    }

    @Test
    public void whenRomanNumberIsIII() {
        viewModel.setRomanNumberProperty("III");
        assertEquals(true, viewModel.validateRomanNumber(viewModel.getRomanNumberProperty().get()));
    }
    ...
    public void whenArabicNumberIsQWERTY() {
        ...
        assertEquals(false, viewModel.validateArabicNumber(viewModel.getArabicNumberProperty().get()));
    }

    @Test
    public void whenArabicNumberIs123() {
        viewModel.setArabicNumberProperty("123");
        assertEquals(true, viewModel.validateArabicNumber(viewModel.getArabicNumberProperty().get()));
    }
    ...
    @Test
    public void whenConvertArabicToRomanNumberArabicIsQWERTYStatusIsBAD_FORMAT() {
        viewModel.setRBArabToRomChooseProperty(true);
        viewModel.setArabicNumberProperty("QWERTY");
    ...
    @Test
    public void whenConvertRomanToArabicNumberRomanIsQWERTYStatusIsBAD_FORMAT() {
        viewModel.setRBRomToArabChooseProperty(true);
        viewModel.setRomanNumberProperty("QWERTY");
        assertEquals(Status.BAD_FORMAT.toString(), viewModel.getStatusProperty().get());
    }
    ...
    @Test
    public void whenConvertArabicNumberQWERTYToRomanNumberResultStatusIsBAD_FORMAT() {
        viewModel.setRBArabToRomChooseProperty(true);
        viewModel.setArabicNumberProperty("QWERTY");
        viewModel.convertNumber();
        assertEquals(Status.BAD_FORMAT.toString(), viewModel.getStatusProperty().get());
    ...
    @Test
    public void whenConvertRomanNumberQWERTYToArabicNumberResultStatusIsBAD_FORMAT() {
        viewModel.setRBRomToArabChooseProperty(true);
        viewModel.setRomanNumberProperty("QWERTY");
        viewModel.convertNumber();
        assertEquals(Status.BAD_FORMAT.toString(), viewModel.getStatusProperty().get());
