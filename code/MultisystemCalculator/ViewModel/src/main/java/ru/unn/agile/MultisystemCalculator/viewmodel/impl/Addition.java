 ...
 */
public class Addition implements CalculatorInterface.BinaryOperation<Integer, String, String> {
    private final MultisystemCalculatorWrapper calculator;

    public Addition(final MultisystemCalculatorWrapper calculator) {
