 ...
 */
public class Abs implements CalculatorInterface.UnaryOperation<Double, ComplexNum> {
    private final ComplexNumberCalculatorWrapper calculator;
    private ComplexNum arg;


    public Abs(final ComplexNumberCalculatorWrapper calculator) {
        this.calculator = calculator;
    }

    @Override
    public Double perform() {
        return new Double(calculator.abs(arg));
    }
