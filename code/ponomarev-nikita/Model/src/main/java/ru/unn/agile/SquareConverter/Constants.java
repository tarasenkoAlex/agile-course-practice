...
public class Constants {
    ...
    public static final double TO_SQR_SANTIMETER_MULTIPLIER = 10000;
    public static final double TO_SQR_MILLIMETER_MULTIPLIER = 1000000;
    public static final double TO_SQR_YARD_MULTIPLIER = 1.196;
    public static final double TO_SQR_FOOT_MULTIPLIER = 10.76;
