...
public class FractionTest {
    ...
    @Test
    public void isFractionNotEqualInteger() {
        Fraction half = new Fraction(1, 2);
        assertNotEquals(half, 2);
    }

    @Test
    public void isIntegerFractionEqualInteger() {
        Fraction two = new Fraction(2);
        assertEquals(two, 2);
    }

    @Test
    public void isDifferentIntegerDifferent() {
        Fraction ten = new Fraction(10);
        assertNotEquals(ten, 9);
    }

    @Test
    public void canCompareWithObject() {
        assertNotEquals(new Fraction(), new Object());
    }

    @Test
    public void isEqualFractionsEqualByHashCode() {
        Fraction a = new Fraction(1, 2);
        Fraction b = new Fraction(1, 2);
    ...
    @Test
    public void isDifferentFractionsDifferentByHashCode() {
        Fraction a = new Fraction(1, 2);
